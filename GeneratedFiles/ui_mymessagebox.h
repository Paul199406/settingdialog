...
public:
    ...
    void setupUi(QWidget *MyMessageBox)
    {
        ...
        pButtonOk->setMinimumSize(QSize(74, 26));
        pButtonOk->setMaximumSize(QSize(74, 26));
        ...
        pButtonCancel->setMinimumSize(QSize(74, 26));
        pButtonCancel->setMaximumSize(QSize(74, 26));
    ...
    void retranslateUi(QWidget *MyMessageBox)
    {
        ...
        MessageIcon->setText(QApplication::translate("MyMessageBox", "TextLabel", 0));
        MessageContent->setText(QApplication::translate("MyMessageBox", "TextLabel", 0));
