...
void MyTitleBar::initControl()
{
    ...
    m_pButtonMin->setToolTip(QStringLiteral("min"));
    m_pButtonRestore->setToolTip(QStringLiteral("restore"));
    m_pButtonMax->setToolTip(QStringLiteral("max"));
    m_pButtonClose->setToolTip(QStringLiteral("close"));
